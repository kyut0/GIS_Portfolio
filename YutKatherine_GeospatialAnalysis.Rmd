...
> *Figure 4: World map of grape production by country. Map requested and produced within one business day. Created in QGIS.*
  
\includegraphics[width=6.5in]{pdf_files/Alberti.png}  

> *Figure 5: Kriging interpolated Brix (i.e., grape sugar content) values for 2017, 2018, and 2019 across a single block with sampling algorithm solutions for both Landsat and Sentinel imagery. Created in QGIS.*  
...
> *Figure 6: Land classification change using Classification Tree Algorithm in Idrisi Terrset (left). Site suitability analysis created in ArcMap (right).*
...
Final Project, Interactive Shiny Web Application

\includegraphics[width=6in]{pdf_files/penguinDash.png}

\includegraphics[width=6.5in]{pdf_files/penguinFig1.jpg}

> *Figure 7: Interactive shiny web application (top). Histogram of penguin flipper length (in millimeters), colored by species (bottom). Created in RStudio.*


### Advanced GIS Final Project  
Spatial Analysis of Oklahoma Homicide Rates    
<br />    
  
\includegraphics[width=6.5in]{pdf_files/advancedGIS.png}

> *Figure 8: Map of median household income by US Census tract in Oklahoma, with inset maps of Oklahoma City (left) and Tulsa (right). Created in RStudio. See the full project [here](https://docs.google.com/document/d/1jHp_AGw8pgljKzNk5uq4B22E7ThuG6GuwGQUpMq80rQ/edit?usp=sharing).*

\pagebreak

### Capstone: Geoinformatics Seminar  
Remote Sensing Analysis of Tashkent, Uzbekistan:  
Classification Algorithms in Relation to China's Belt and Road Initiative  
<br />   

\includegraphics[width=7in]{pdf_files/LC.png}  

> *Figure 9: Land change model output showing wildland-urban interactions in Tashkent, Uzbekistan for the past two decades. Created in RStudio. Read the final paper [here](https://docs.google.com/document/d/1-o5xDdMhyRrh9HsPgWNMQKh8G-qdN3Ix5bGZMiKhgQI/edit?usp=sharing) and see the full project [here](https://drive.google.com/file/d/14mGFsjwAPgD3zB5fC9TVQnENcrOI7dFL/view?usp=sharing).*
...
> *Figure 10: Time series by semester showing cumulative (light grey) and count (dark grey) of RStudio data science classes taken. Created in RStudio using ggplot2.*  
